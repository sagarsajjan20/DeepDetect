    ...
    <div className="container mx-auto py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-blue dark:prose-invert max-w-none">
          ...
          <p>
            Welcome to DeepDetect AI ("we," "our," or "us"). We are committed to protecting your privacy and ensuring
            the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and
            safeguard your information when you use our deepfake detection service.
          </p>
          ...
          <ul>
            ...
            <li>Improving our deepfake detection algorithms</li>
          ...
          <ul>
            <li>Email: privacy@deepdetect.ai</li>
