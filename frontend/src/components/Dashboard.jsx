...
import { Upload, Copy, CheckCircle, Clock, BarChart2, Image } from "lucide-react"
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const response = await fetch("https://deepdetect-s9ar.onrender.com/api/user/dashboard", {
          headers: {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8">
        ...
        <div className="flex items-center">
          <div className="flex-1 bg-gray-100 dark:bg-gray-700 rounded-l-lg p-3 font-mono text-base overflow-x-auto">
            {apiKey || "Please Upgrade to Get Your API_KET!!"}
          </div>
          <button
            onClick={copyApiKey}
