...
const AuthModal = ({ type = "signin", onClose, onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let endpoint = "https://deepdetect-s9ar.onrender.com/api/user/"
      ...
      if (data.status === "success") {
        ...
        setSuccess(data.data || (type === "signin" ? "Sign in successful!" : "Account created successfully!"))
        setTimeout(() => {
          onLogin()
        }, 1000)
      } else {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        <div className="p-8">
          <h2 className="text-2xl font-bold mb-6 text-center">{type === "signin" ? "Sign In" : "Create Account"}</h2>
          ...
          {success && (
            <div className="mb-4 p-3 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-2 text-green-800 dark:text-green-300">
              <Check size={18} />
              <span>{success}</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
              ...
              <p className="text-gray-600 dark:text-gray-400">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    onClose()
                    setTimeout(() => {
                      document.querySelector('[data-auth-type="signup"]')?.click()
                    }, 100)
                  }}
              ...
              <p className="text-gray-600 dark:text-gray-400">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    onClose()
                    setTimeout(() => {
                      document.querySelector('[data-auth-type="signin"]')?.click()
                    }, 100)
                  }}
                  className="dark:text-blue-400 hover:underline font-medium"
                >
