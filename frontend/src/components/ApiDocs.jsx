...
const ApiDocs = () => {
  ...
  const apiEndpoint = "https://deepdetect-s9ar.onrender.com/api/predict/api-key"
...
fileInput.addEventListener('change', (e) => {
  detectDeepfake(e.target.files[0]);
});`
...
// Example usage
detectDeepfake('path/to/image.jpg')
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden mb-8">
          <div className="p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Integrate deepfake detection capabilities using our API. Follow these steps:
            </p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg p-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-blue-800 dark:text-blue-300">Base URL</h3>
                  <p className="text-blue-600 dark:text-blue-400 font-mono">{apiEndpoint}</p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden mb-8">
          <div className="p-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg mb-6">
              ...
              <div className="p-4">
                <p className="text-gray-600 dark:text-gray-400 mb-4">Analyze an image file for deepfake detection.</p>
