...
const PricingCard = ({ plan, features, price, apiCalls, isPopular, onSelect }) => {
  return (
    ...
    >
      {isPopular && (
        <div className="bg-blue-500 dark:bg-blue-600 text-white text-center py-1 text-sm font-medium">Active Plan</div>
      )}
  ...
  <div
    className={`block w-full py-2 px-4 rounded-lg text-center font-medium ${
      isPopular
        ...
        : "border border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 cursor-not-allowed opacity-75"
    }`}
  >
    Coming Soon
  </div>
  ...
  const plans = [
    {
      ...
      price: 700,
      apiCalls: 100,
      features: ["Basic deepfake detection", "Web interface access", "Standard response time", "Community support"],
      isPopular: false,
    },
    {
      plan: "Pro",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Choose the plan that's right for you and start detecting deepfakes today.
          </p>
